...
const Navbar = () => {
	...
	const submitSearch = (e: React.FormEvent<HTMLFormElement> | React.MouseEvent<HTMLButtonElement>) => {
		e.preventDefault();
	...
	return (
		<div className="w-full flex justify-between items-center border-b-2 border-gray-200 py-2 px-4">
			...
			<div className="relative hidden md:block">
				<form onSubmit={submitSearch} className="absolute md:static top-10 -left-20 bg-white">
					<input
						value={searchValue}
			...
			<div>
				{userProfile ? (
					<div className="flex gap-5 md:gap-10 items-center">
						...
						<button
							type="button"
							className=" border-2 p-2 rounded-full cursor-pointer outline-none shadow-md w-[40px] h-[40px]"
							onClick={() => {
								googleLogout();
								removeUser();
							}}
